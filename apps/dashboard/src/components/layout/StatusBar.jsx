/**
 * StatusBar.jsx — Top navigation bar showing cluster health at a glance.
 *
 * Moved from: frontend/src/components/StatusBar.jsx
 * New location: apps/dashboard/src/components/layout/StatusBar.jsx
 *
 * Placed in layout/ because the status bar is a shell-level concern —
 * it frames the entire app and should be near AppShell.jsx, not mixed
 * with feature-specific components (graph/, insights/, pods/).
 *
...
Pill.propTypes = { label: PropTypes.string, count: PropTypes.number, color: PropTypes.string };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        >
          {/* Network graph icon — three nodes connected by edges, mirrors the dependency graph */}
